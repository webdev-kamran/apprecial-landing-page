                    ...
                    <div className="space-y-10">
                        ...
                        <div className="space-y-5">
                            <div className="flex justify-center gap-3">
                                <Image
                                    ...
                                    src={'/images/apprecial-icon.svg'}
                                    width={20}
                                    height={20}
                                    loading="eager"
                                    alt=" "
                                /><h2 className="text-center text-zinc-800 text-4xl font-bold ">Accounts</h2>
                        ...
                        <div className="flex flex-col md:grid md:grid-cols-2 gap-10">
                            <div className="bg-white rounded-xl shadow p-5 lg:p-10">
                                {/* Icon */}
                                <div className="w-20 h-20 border border-primmary/10 rounded-full flex justify-center items-center mx-auto">
                                    <svg viewBox="0 0 52 63" className="w-8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M26.0723 29.8225C34.3075 29.8225 40.9836 23.1465 40.9836 14.9112C40.9836 6.67589 34.3075 -0.00012207 26.0723 -0.00012207C17.837 -0.00012207 11.161 6.67589 11.161 14.9112C11.161 23.1465 17.837 29.8225 26.0723 29.8225Z" fill="#6289CD" />
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M26.0732 34.9268C19.1082 34.9268 18.8244 31.5774 14.7593 30.2426C8.41906 28.16 2.78091 36.0014 1.37493 41.4638C-0.760107 49.7553 -0.412706 62.2612 10.1949 62.2612H22.2442H22.2491H22.2636H22.2875H22.3212H22.3645H22.4176H22.48H22.5522H22.584H22.634H22.7256H22.8268H22.9375H22.9551H23.0578H23.1876H23.3158H23.3273H23.4765H23.6353H23.6672H23.8039H23.9818H24.0088H24.1695H24.3407H24.3665H24.5732H24.6627H24.7897H24.9752H25.0155H25.2514H25.2781H25.4966H25.5718H25.7516H25.8555H26.0162H26.1299H26.2906H26.3945H26.5743H26.6495H26.868H26.8947H27.1306H27.1709H27.3564H27.4834H27.5728H27.7796H27.8054H27.9766H28.1373H28.1643H28.3422H28.4789H28.5108H28.6696H28.8185H28.83H28.9582H29.088H29.1907H29.2083H29.319H29.4202H29.5114H29.5615H29.5933H29.6654H29.7279H29.7809H29.8243H29.8579H29.8819H29.8964H29.9013H41.9506C52.5585 62.2612 52.9056 49.7553 50.7706 41.4638C49.3646 36.0018 43.7264 28.1604 37.3862 30.2426C33.321 31.5777 33.037 34.9268 26.0723 34.9268H26.0732Z" fill="#6289CD" />
                                    </svg>
                                </div>

                                <div className="space-y-4 pt-5">
                                    <h3 className="text-zinc-800 font-medium capitalize text-center text-3xl">Personal</h3>
                                    <p className="text-center text-zinc-800 text-lg font-normal leading-snug">Unlock the full potential of Apprecial's mobile-based services with our intuitive and feature-rich dashboard.</p>
                                </div>

                                <div className="p-5 bg-slate-50 rounded-3xl mt-10">
                                    <div className="w-60 max-w-full mx-auto divide-y divide-primary/10">
                                        {list.map((item: any, index: any) => {
                                            return (
                                                <>
                                                    <div className="flex items-start gap-3 py-3">
                                                        <TbCheck size="20" className="text-green-600" /><p className="text-[#011D41]/70">{item}</p>
                                                    </div>
                                                </>
                                            );
                                        })}
